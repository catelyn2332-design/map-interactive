...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-IjdiAokR.mjs");
...
var manifest = {
	"308f6180ab4873bf6213a8d79116a4b6f20a9b9a053cecb2c5662179703595f3": {
		functionName: "clearCloudPrefs_createServerFn_handler",
		importer: () => import("./cloud-7a2KgQQf.mjs")
	},
	"81971174ac0cf4fd91b14e4497b90ab537607fa2bb83cc8f373dc660e14c6d0d": {
		functionName: "saveCloudPrefs_createServerFn_handler",
		importer: () => import("./cloud-7a2KgQQf.mjs")
	},
	"994483c8865cf3a0a1b79004353266d3d35d745ea47c8fbdc954e07c5ab869d8": {
		functionName: "loadCloudPrefs_createServerFn_handler",
		importer: () => import("./cloud-7a2KgQQf.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-0jzItr0j.mjs").then((n) => n.t),
