...
//#region node_modules/.nitro/vite/services/ssr/assets/middleware-LXT0xpiK.js
...
var _0002_atlas_cloud_default = "create table if not exists atlas_cloud (\n  user_id text primary key,\n  payload text not null,\n  saved_at timestamptz not null default now()\n);\n";
/**
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_atlas_cloud.sql": _0002_atlas_cloud_default
		});
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-C1WHYkgy.mjs");
